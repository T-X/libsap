...
### libsap example, threaded/non-blocking:
...
* https://code.videolan.org/videolan/vlc/-/blob/master/modules/services\_discovery/sap.c
* https://code.videolan.org/videolan/vlc/-/blob/master/src/stream\_output/sap.c
